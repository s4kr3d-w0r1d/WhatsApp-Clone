        ...
        <div>
            <div className='bg-slate-800/30 border border-slate-400 rounded-md p-8 shadow-lg backdrop-filter backdrop-blur-sm bg-opacity-30 relative'>
                ...
                <form onSubmit={handleLogin}>
                    ...
                    <button className='w-full mb-4 text-[18px] mt-6 rounded-full bg-white text-pink-500 hover:bg-pink-400 hover:text-white py-2 transition-colors duration-600' type="submit">Login</button>
                    <div>
